...
# Importing images to memmeory and resizing them to 75x75 pixels so that they dont overload the GPU/CPU
...
# Defining the model # inspired by the AlexNet model that performs well on the MNIST data
def myModel():
    noOfFilters=60
    sizeOfFilter=(5,5)
    sizeOfFilter2=(3,3)
...
# Batch size can be less here becuase the dataset is small
batchSizeValue=16
